    ...
    */
    ...
    'connections' => [
        ...
        'shard_1' => [
            ...
            'url' => env('DB_SHARD1_URL'),
            'host' => env('DB_SHARD1_HOST', '127.0.0.1'),
            'port' => env('DB_SHARD1_PORT', '3306'),
            'database' => env('DB_SHARD1_DATABASE', 'laravel'),
            'username' => env('DB_SHARD1_USERNAME', 'root'),
            'password' => env('DB_SHARD1_PASSWORD', ''),
            'unix_socket' => env('DB_SHARD1_SOCKET', ''),
            'charset' => env('DB_SHARD1_CHARSET', 'utf8mb4'),
            'collation' => env('DB_SHARD1_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
        ...
        'shard_2' => [
            'driver' => env('DB_SHARD2_DRIVER', 'mysql'),
            'url' => env('DB_SHARD2_URL'),
            'host' => env('DB_SHARD2_HOST', '227.0.0.2'),
            'port' => env('DB_SHARD2_PORT', '3306'),
            'database' => env('DB_SHARD2_DATABASE', 'laravel'),
            'username' => env('DB_SHARD2_USERNAME', 'root'),
            'password' => env('DB_SHARD2_PASSWORD', ''),
            'unix_socket' => env('DB_SHARD2_SOCKET', ''),
            'charset' => env('DB_SHARD2_CHARSET', 'utf8mb4'),
            'collation' => env('DB_SHARD2_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
        ...
        'shard_3' => [
            'driver' => env('DB_SHARD1_DRIVER', 'mysql'),
            'url' => env('DB_SHARD3_URL'),
            'host' => env('DB_SHARD3_HOST', '327.0.0.3'),
            'port' => env('DB_SHARD3_PORT', '3306'),
            'database' => env('DB_SHARD3_DATABASE', 'laravel'),
            'username' => env('DB_SHARD3_USERNAME', 'root'),
            'password' => env('DB_SHARD3_PASSWORD', ''),
            'unix_socket' => env('DB_SHARD3_SOCKET', ''),
            'charset' => env('DB_SHARD3_CHARSET', 'utf8mb4'),
            'collation' => env('DB_SHARD3_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
